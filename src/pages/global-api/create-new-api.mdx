...
# Create new API {{ tag: 'POST', label: '/api/v1/{APP_ID}/{APP_KEY}' }}

<br />

## Create API {{ tag: 'POST', label: '/api/v1/{APP_ID}/{APP_KEY}/create' }}
...
## Create API with JSON {{ tag: 'POST', label: '/api/v1/{APP_ID}/{APP_KEY}/create' }}
