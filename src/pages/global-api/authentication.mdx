...
`https://sheetdb.test/api/v1/global/{API_KEY}/list`

Replace `{APP_KEY}` with your API key. In addition, each request **must include your secret** in the body of the request.
