...
<Row>
  <Col>
    ...
    If you want a row to be included in the result when any condition is met, use the serach_or endpoint, example: [https://sheetdb.io/api/v1/58f61be4dda40/search_or?name=Tom&age=22](https://sheetdb.io/api/v1/58f61be4dda40/search_or?name=Tom&age=22)
